        ...
        <div className="testimonials">
            ...
            <div className="tCards">
                ...
                <AnimatePresence mode='wait'>
                    {testimonial==0 && 
                    <motion.div key={0} initial={{ x: direction == 'right'? 100 : -100, opacity: 0 }} animate={{ x: 0, opacity: 1 }} exit={{ x: direction == 'right' ? -100 : 100, opacity: 0 }} transition={{ duration: 0.3 }} className="card">
                    ...
                    {testimonial==1 && 
                    <motion.div key={1} initial={{ x: direction == 'right'? 100 : -100, opacity: 0 }} animate={{ x: 0, opacity: 1 }} exit={{ x: direction == 'right' ? -100 : 100, opacity: 0 }} transition={{ duration: 0.3 }} className="card">
                    ...
                    {testimonial==2 && 
                    <motion.div key={2} initial={{ x: direction == 'right'? 100 : -100, opacity: 0 }} animate={{ x: 0, opacity: 1 }} exit={{ x: direction == 'right' ? -100 : 100, opacity: 0 }} transition={{ duration: 0.3 }} className="card">
